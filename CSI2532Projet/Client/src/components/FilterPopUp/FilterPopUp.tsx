...
function FilterPopUp(){
    ...
    const handleClick = (setColor: React.Dispatch<React.SetStateAction<string>>, setColorText: React.Dispatch<React.SetStateAction<string>>,color: string, num:number ) => {
        setC(color)
        setNumberPeople(num)
        setColorAny("#FFFFFF")
    ...
    return(
        <div className="filterContainer">
            ...
            <div className="buttonsContainer">
                <div className="Any" style={{
                    backgroundColor: colorAny
                }} onClick={()=>handleClick(setColorAny,setColorAnyText,colorAny,-1)}>
                    <p className="anytext" style={{
                        color: colorAnyText
                    }}>Any</p>
                </div>
                <div className="one" style={{
                    backgroundColor: colorOne
                }}  onClick={()=>handleClick(setColorOne,setColorOneText,colorOne,1)}>
                    <p className="onetext" style={{
                        color: colorOneText
                    }}>1</p>
                </div>
                <div className="two"  style={{
                    backgroundColor: colorTwo
                }}  onClick={()=>handleClick(setColorTwo,setColorTwoText,colorTwo,2)}>
                    <p className="twotext" style={{
                        color: colorTwoText
                    }}>2</p>
                </div>
                <div className="three" style={{
                    backgroundColor: colorThree
                }}  onClick={()=>handleClick(setColorThree,setColorThreeText,colorThree,3)}>
                    <p className="threetext"  style={{
                        color: colorThreeText
                    }}>3</p>
                </div>
                <div className="four"  style={{
                    backgroundColor: colorFour
                }}  onClick={()=>handleClick(setColorFour,setColorFourText,colorFour,4)}>
                    <p className="fourtext"   style={{
                        color: colorFourText
                    }}>4</p>
                </div>
                <div className="five"   style={{
                    backgroundColor: colorFive
                }}  onClick={()=>handleClick(setColorFive,setColorFiveText,colorFive,5)}>
                    <p className="fivetext"  style={{
                        color: colorFiveText
                    }}>5+</p>
                </div>
            </div>
            ...
            <select className="dropdown" value={hotelChain} onChange={handleSelectChange}>
            ...
            <input
                ...
                placeholder="Enter the category of desired hotel"
            />
        </div>
    );
